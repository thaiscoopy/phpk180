	...
	<div class="container">
		<div class="row">
        	<div id="logo" class="col-lg-5 col-md-5 col-sm-12">
            	<a href="index3.php">vietpro academy</a>
            </div>
            <div id="menu" class="col-lg-5 col-md-5 col-sm-12">
            <a href="index3.php?style=style1">Style 01</a> | 
            <a href="index3.php?style=style2">Style 02</a> | 
            <a href="index3.php?style=style3">Style 03</a> | 
            <a href="index3.php?style=style4">Style 04</a></div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <?php echo $arr ['title'];?>
                            <small><?php echo $arr ['description'];?></small>
                        </h2>
                    </div>
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
                                    <th width="60%"><?php echo $arr ['name'];?></th>
                                    <th width="15%" class="text-center"><?php echo $arr ['preview'];?></th>
                                    <th width="15%" class="text-center"><?php echo $arr ['download'];?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="active">
